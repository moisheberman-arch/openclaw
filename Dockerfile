...
RUN --mount=type=cache,id=s/94f1d729-72a2-4dc5-b061-5e407d11efaf-openclaw-pnpm-store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/94f1d729-72a2-4dc5-b061-5e407d11efaf-openclaw-bookworm-apt-cache,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/94f1d729-72a2-4dc5-b061-5e407d11efaf-openclaw-bookworm-apt-lists,target=/var/lib/apt,sharing=locked \
    apt-get update && \
